WITH row_rank_1 AS (
    ...
    FROM DBTVAULT_SAMPLE.SAMPLE_SCHEMA.stg_customer AS rr
...
row_rank_2 AS (
    ...
    FROM DBTVAULT_SAMPLE.SAMPLE_SCHEMA.stg_orders AS rr
    WHERE rr."CUSTOMER_HK" IS NOT NULL
    QUALIFY row_number = 1
),
stage_union AS (
...
records_to_insert AS (
    ...
    LEFT JOIN DBTVAULT_SAMPLE.SAMPLE_SCHEMA.hub_orders_multi_source_incremental AS d
