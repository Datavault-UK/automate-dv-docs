/* From https://github.com/argoproj/argo-cd/blob/master/docs/assets/versions.js */
...
setTimeout(function () {
    ...
    CSSLink.href = './versions.css';
    document.getElementsByTagName('head')[0].appendChild(CSSLink);

    var script = document.createElement('script');
    script.src = 'https://readthedocs.org/api/v3/projects/dbtvault/versions/' +
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    if (rtdData.version !== "latest") {
        document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for an unreleased version of dbtvault, <a href='https://dbtvault.readthedocs.io/en/latest/'>click here to go to the latest stable version.</a></div>"
