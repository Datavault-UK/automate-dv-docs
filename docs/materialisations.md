...
([view source](https://github.com/Datavault-UK/dbtvault/blob/release/0.9.4/macros/materialisations/vault_insert_by_period_materialization.sql))
...
See the [hub](https://github.com/Datavault-UK/dbtvault/blob/release/0.9.4/macros/tables/hub.sql) source code for 
...
([view source](https://github.com/Datavault-UK/dbtvault/blob/release/0.9.4/macros/materialisations/vault_insert_by_rank_materialization.sql))
...
([view source](https://github.com/Datavault-UK/dbtvault/blob/release/0.9.4/macros/materialisations/incremental_pit_materialization.sql))
...
([view source](https://github.com/Datavault-UK/dbtvault/blob/release/0.9.4/macros/materialisations/incremental_bridge_materialization.sql))
