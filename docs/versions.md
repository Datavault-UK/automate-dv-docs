...
| [v0.8.0](https://hub.getdbt.com/datavault-uk/automate_dv/0.8.0/)             | >=1.0.0, <2.0.0 | Use latest dbt 1.0.x version                                               |
| [v0.7.9](https://hub.getdbt.com/datavault-uk/automate_dv/0.7.9/)             | >=1.0.0, <2.0.0 | Use latest dbt 1.0.x version                                               |
