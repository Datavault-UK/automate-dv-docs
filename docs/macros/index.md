...
=== "Snowflake"
    ...
    === "Single-Source (Base Load)"
        ...
        ```sql
        --8<-- "docs/assets/snippets/raw_vault/hubs/hub_customer.sql"
        ```
    
    === "Single-Source (Subsequent Loads)"
    
        ```sql
        --8<-- "docs/assets/snippets/raw_vault/hubs/hub_customer_incremental.sql"
        ```
    
    === "Multi-Source (Base Load)"

        ```sql
        --8<-- "docs/assets/snippets/raw_vault/hubs/hub_orders_multi_source.sql"
        ```
    
    === "Multi-Source (Subsequent Loads)"
 
        ```sql
        --8<-- "docs/assets/snippets/raw_vault/hubs/hub_orders_multi_source_incremental.sql"
        ```
